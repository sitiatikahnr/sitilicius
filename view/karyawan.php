        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="../lib/karyawan.php" method="post">
                <div class="form-group">
                  <table border="0" cellpadding="1" cellspacing="2" width="550">
                  <td height="19" colspan="2" align="center" valign="middle">
                  <tr><td width="50"></td>
                  <td width="100">
                  <tr><td>Jabatan</td><td><input type="text" name="status" class="form-control" required></td></tr>
                  <tr><td>Nama Karyawan</td><td><input type="text" name="nama" class="form-control" ></td></tr>
                  <tr><td>Ruang</td><td><input type="text" name="ruang" class="form-control" ></td></tr>
                  <tr><td>Tgl Daftar</td><td><input type="date" name="tgl" class="form-control" placeholder="yyyy-MM-dd"  ></td></tr>
                  <tr><td>Jenis Kelamin</td><td>
                  <p style="margin-top:5px;"><input type="radio" name="jenis_kelamin" value="L" > &nbspLaki-laki
                  <input type="radio" name="jenis_kelamin" value="P" required>&nbspPerempuan</p></td></tr>
                  <tr><td>Alamat</td><td><textarea name="alamat" class="form-control" rows="3" ></textarea></td></tr>
                  <tr><td>Telepon</td><td><input type="text" name="tlp" class="form-control" ></td></tr>
                  </table>
                </div>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Karyawan</th><th>Alamat</th><th>No Tlp</th><th>Aksi</th></tr>
                          <?php
                            ...
                            $a=mysql_query("select * from karyawan order by kd_karyawan DESC limit 5");
                            $no=1;
