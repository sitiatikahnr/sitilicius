      ...
      <div class="container" >
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="#about"><span class="glyphicon glyphicon-user"></span>&nbsp&nbspProfil</a></li>
        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              Lihat Data Karyawan &nbsp&nbsp&nbsp<span class="glyphicon glyphicon-hand-right"></span>&nbsp&nbsp&nbsp<a href="Karyawan" style="text-decoration:none; color:blue;">Tambah Data Karyawan</a>
              </h3>
            </div>
            <div class="panel-body">
            <form class="navbar-form pull-right" action="Cari_Karyawan" method="post">
              <div class="form-group" style='margin-right:0px;padding-right:0px;margin-left:30px;'>
              <input type="text" class="form-control" placeholder="Karyawan" name="cari" size='30'>
              </div>
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
            </form>
              <h3 style="margin:0px; padding:0px;">Data Karyawan</h3><hr>
              <br><br>

               <table class="table table-striped">
                <tr><th>No</th><th>Nama Karyawan</th><th>Jenis Kelamin</th><th>Status</th><th>Alamat</th><th>No Tlp</th><th>Aksi</th></tr>
                          <?php
