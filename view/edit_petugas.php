        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              Tambah Petugas &nbsp&nbsp&nbsp<span class="glyphicon glyphicon-hand-right"></span>&nbsp&nbsp&nbsp<a href="Data_Petugas" style="text-decoration:none; color:blue;">Lihat Data Petugas</a>
              </h3>
            </div>
            <div class="panel-body">
              <h3 style="margin:0px; padding:0px;">Tambah Petugas</h3><hr>
              <form role="form" action="../lib/edit_petugas.php" method="post">
                            <?php
                           
                            $query = mysql_query("select * from petugas where kd_petugas='$_GET[id]'");
                ...
                <div class="form-group">
                  ...
                  <tr><td width="50"></td>
                  <td width="100">
                  <tr><td></td><td><input type="hidden" name="petugas" class="form-control" 
                  <?php echo"value='$array[kd_petugas]'";?>></td></tr>
                  <tr><td>Nama Petugas</td><td><input type="text" name="nama" class="form-control"
                  <?php echo"value='$array[nama_petugas]'";?>></td></tr>
                  <tr><td>Jenis Kelamin</td><td>
                  <?php
                  if($array['jenis_kelamin']==L){
                  ...
                  ?></td></tr>
                  <tr><td>Alamat</td><td><textarea name="alamat" class="form-control" rows="3" >
                  <?php echo" $array[alamat]";?></textarea></td></tr>
                  <tr><td>Telepon</td><td><input type="text" name="tlp" class="form-control"
                  <?php echo"value='$array[tlp]'";?>></td></tr>
                  <tr><td>Username</td><td><input type="text" name="user" class="form-control"
                  <?php echo"value='$array[user]'";?>></td></tr>
                  <tr><td>Password</td><td><input type="password" name="pass" class="form-control"
                  <?php echo"value='$array[password]'";?>></td></tr>
                  </table>
                </div>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Petugas</th><th>Alamat</th><th>No Tlp</th><th>Aksi</th></tr>
                                <?php
                               
                                $a=mysql_query("select * from petugas where hak_akses='0'");
								$no=1;
                                while($b=mysql_fetch_array($a)){
                                  echo"
                                        ...
                                        <td>$b[tlp]</td>
                                        <td>
                                        <a href='edit_petugas.php?id=$b[kd_petugas]'><span class='glyphicon glyphicon-pencil'></span></a>&nbsp
                                        <a href='../lib/hapus.php?lib=petugas&id=$b[kd_petugas]'><span class='glyphicon glyphicon-trash'></span></a>
                                  ";
								  $no++;
                                }
                                ?>
