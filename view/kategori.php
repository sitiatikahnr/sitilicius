        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="../lib/kategori.php" method="post">
                <div class="form-group">
                  <table border="0" cellpadding="1" cellspacing="1" width="550">
                      <td height="19" colspan="2" align="center" valign="middle">
                      <tr><td width="50"></td>
                      <td width="100">
                      <tr><td>Nama Kategori</td><td><input type="text" name="nama" class="form-control" required></td></tr>
                      </td></tr> </td>
                     </table>
                </div>
              ...
              <table class="table table-striped">
                ...
                <?php
                      ...
                      $a=mysql_query("select * from kategori order by kd_kategori DESC limit 5");
                      $no=1;
