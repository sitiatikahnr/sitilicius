        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              Data Petugas &nbsp&nbsp&nbsp<span class="glyphicon glyphicon-hand-right"></span>&nbsp&nbsp&nbsp<a href="Petugas" style="text-decoration:none; color:blue;">Tambah Data Petugas</a>
              </h3>
            </div>
            <div class="panel-body">
            <form class="navbar-form pull-right" action="Cari_Petugas" method="post">
              <div class="form-group" style='margin-right:0px;padding-right:0px;margin-left:30px;'>
              <input type="text" class="form-control" placeholder="Petugas" name="cari" size='30'>
              </div>
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
            </form>
              <h3 style="margin:0px; padding:0px;">Data Petugas</h3><hr>
