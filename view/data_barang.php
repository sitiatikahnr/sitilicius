        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              Data Barang &nbsp&nbsp&nbsp<span class="glyphicon glyphicon-hand-right"></span>&nbsp&nbsp&nbsp
              <a href="Barang" style="text-decoration:none; color:blue;">Tambah Data Barang</a>&nbsp&nbsp&nbsp
              </h3>
            </div>
            ...
            <form class="navbar-form pull-right" action="Cari_Barang" method="post">
              ...
              <input type="text" class="form-control" placeholder="Data Barang" name="cari" size='30'>
              </div>
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
            </form>
              <h3 style="margin:0px; padding:0px;">Data Barang</h3><hr>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Barang</th><th>Kategori</th><th>Merk</th><th>Pembuat</th><th>Tahun Buat</th><th>Aksi</th></tr>
                      ...
                      $tampil = mysql_query("select alat.kd_alat,alat.label_alat,kategori.kategori_alat,alat.merk,pembuat.nama_pembuat,alat.thn_buat from alat,kategori,pembuat
                        where alat.kd_kategori=kategori.kd_kategori and alat.kd_pembuat=pembuat.kd_pembuat");
                      $no=1;
