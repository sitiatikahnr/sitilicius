        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="../lib/barang.php" method="post">
                <div class="form-group">
                  <table border="0" cellpadding="1" cellspacing="1" width="550">
                      <td height="19" colspan="2" align="center" valign="middle">
                      <tr><td width="50"></td>
                      <td width="100">
                      <tr><td>Nama Alat</td><td><input type="text" name="nama" class="form-control" required></td></tr>
                      <tr><td>Model</td><td><input type="text" name="model" class="form-control" ></td></tr>
                      ...
                      <tr><td>Merk</td><td><input type="text" name="merk" class="form-control" ></td></tr>
                      <tr><td>Pembuat</td><td><select name="kode_pembuat" class="form-control" >
                       ...
                       <tr><td>Tahun Buat</td><td><input type="text" name="thn" class="form-control"></td></tr>              
                     </table>
                </div>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Barang</th><th>Kategori</th><th>Merk</th><th>Pembuat</th><th>Tahun Buat</th><th>Aksi</th></tr>
                      ...
                      $tampil = mysql_query("select alat.kd_alat,alat.label_alat,kategori.kategori_alat,alat.merk,pembuat.nama_pembuat,alat.thn_buat from alat,kategori,pembuat
                        where alat.kd_kategori=kategori.kd_kategori and alat.kd_pembuat=pembuat.kd_pembuat order by kd_alat desc limit 5");
                      $no=1;
