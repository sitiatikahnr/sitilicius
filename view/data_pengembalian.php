            ...
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
             ...
             <table class="table table-striped">
                <tr><th>Kode Inventaris</th><th>Nama Barang</th><th>Tanggal Kembali</th><th>Aksi</th></tr>
                                <?php
                                  $a=mysql_query("select pengembalian.kd_inventaris,alat.label_alat,alat.kd_alat,pengembalian.tgl_kembali from pengembalian,alat where pengembalian.kd_alat=alat.kd_alat");
