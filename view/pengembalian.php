        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              Pengembalian &nbsp&nbsp&nbsp<span class="glyphicon glyphicon-hand-right"></span>&nbsp&nbsp&nbsp<a href="Data_Pengembalian" style="text-decoration:none; color:blue;">Lihat Data Barang Kembali</a>
              </h3>
            </div>
            <div class="panel-body">
            <form class="navbar-form pull-right" action="Cari_Kembali" method="post">
              <div class="form-group" style='margin-right:0px;padding-right:0px;margin-left:30px;'>
              <input type="text" class="form-control" placeholder="Pengembalian" name="cari" size='30'>
              </div>
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
            </form>
              <br><br>
              <h3 style="margin:0px; padding:0px;">Data Pengembalian</h3><hr>
             <table class="table table-striped">
                <tr><th>Kode Inventaris</th><th>Nama Barang</th><th>Status</th><th>Aksi</th></tr>
                                <?php
                                  $a=mysql_query("select detail_inventaris.kd_inventaris,alat.label_alat,alat.kd_alat,detail_inventaris.status,detail_inventaris.id from detail_inventaris,alat where detail_inventaris.kd_alat=alat.kd_alat");
                                    while($b=mysql_fetch_array($a)){
                                      echo"
                                          ...
                                          ";
                                          if($b['status']==0){
                                            echo"<a href='../lib/kembalikan.php?kode=$b[kd_inventaris]&nama=$b[kd_alat]&id=$b[id]'><button type='button' class='btn btn-warning'>Dipinjam</button></a>";
                                          }
                                          else{
                                          ...
                                          <td>
                                          <a href='../lib/hapus.php?lib=detail&id=$b[kd_inventaris]'><span class='glyphicon glyphicon-trash'></span></a>
                                          </td></tr>
                                      ";
                                    }
