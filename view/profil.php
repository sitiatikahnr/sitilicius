        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <h3 style="margin:0px; padding:0px;"><?php echo"Profil $_SESSION[username]";?></h3><hr>
                <div class="form-group">
                  <table border="0" cellpadding="1" cellspacing="1" width="550">
                      ...
                      <td width="100">
                      <?php
                      $a = mysql_query("select * from petugas where kd_petugas=$_SESSION[id]");
                      $b = mysql_fetch_array($a);
                      ?>
                      <tr><td>Nama </td><td><p><?php echo"$b[nama_petugas]";?></p></td></tr>
                      <tr><td>Alamat </td><td><p><?php echo"$b[alamat]";?></p></td></tr>
                      <tr><td>Telepon </td><td><p><?php echo"$b[tlp]";?></p></td></tr>                                          
                     </table>
                </div>
              <br><br>
            </div>
