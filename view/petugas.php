        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="../lib/petugas.php" method="post">
                <div class="form-group">
                  ...
                  <tr><td>Nama Petugas</td><td><input type="text" name="nama" class="form-control" required></td></tr>
                  <tr><td>Jenis Kelamin</td><td>
                  <p style="margin-top:5px;"><input type="radio" name="jenis_kelamin" value="L" >&nbspLaki-laki&nbsp&nbsp&nbsp&nbsp
                  <input type="radio" name="jenis_kelamin" value="P" >&nbspPerempuan</p></td></tr>
                  <tr><td>Alamat</td><td><textarea name="alamat" class="form-control" rows="3" ></textarea></td></tr>
                  <tr><td>Telepon</td><td><input type="text" name="tlp" class="form-control" maxlength="12" ></td></tr>
                  <tr><td>Username</td><td><input type="text" name="user" class="form-control" ></td></tr>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Petugas</th><th>Alamat</th><th>No Tlp</th><th>Aksi</th></tr>
                                ...
                                $a=mysql_query("select * from petugas where hak_akses='0' order by kd_petugas DESC limit 5");
                                $no=1;
                                while($b=mysql_fetch_array($a)){
                                  echo"
                                        ...
                                        <td>$b[tlp]</td>
                                        <td>
                                        <a href='Edit_Petugas?id=$b[kd_petugas]'><span class='glyphicon glyphicon-pencil'></span></a>&nbsp
