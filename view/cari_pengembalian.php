      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <form class="navbar-form pull-right" action="Cari_Pengembalian" method="post">
            ...
            <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-search"></span></button>
              ...
              <h3 style="margin:0px; padding:0px;">Hasil Cari</h3><hr>
                ...
                <tr><th>Kode Inventaris</th><th>Nama Barang</th><th>Tanggal Kembali</th><th>Aksi</th></tr>
                                  <?php
                                  
                                  $a = mysql_query("select * from pengembalian where kd_inventaris like '%$_POST[cari]%' ");
                                  $hitung = mysql_num_rows($a);
                                  if($hitung==0){echo"Data yang anda cari tidak ada";}
                                  else{
                                    while($b = mysql_fetch_array($a)){
                                      $re=mysql_fetch_array(mysql_query("select * from alat where kd_alat='$b[kd_alat]'"));
                                      ...
                                      echo"
                                          ...
                                          <td>
                                          <a href='Edit_Detail?id=$b[kd_inventaris]'><span class='glyphicon glyphicon-pencil'></span></a>&nbsp
