        ...
        <div class="col-xs-12 col-sm-9">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="../lib/pembuat.php" method="post">
              <table border="0" cellpadding="1" cellspacing="2" width="550">
                  <td height="19" colspan="2" align="center" valign="middle">
                  <tr><td width="50"></td>
                  <td width="100">
                  <tr><td>Nama Pembuat</td><td><input type="text" name="nama" class="form-control" required></td></tr>
                  <tr><td>Kota</td><td><input type="text" name="kota" class="form-control" ></td></tr> 
                  </table>
              ...
              <table class="table table-striped">
                <tr><th>No</th><th>Nama Pembuat</th><th>Kota</th><th>Aksi</th></tr>
                          ...
                          $a =mysql_query(" select * from pembuat order by kd_pembuat DESC limit 5");
                          $no=1;
